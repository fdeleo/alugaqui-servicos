...
public class ImovelController {
  ...
  @RequestMapping(value = "/imoveis/busca/{busca}", method = RequestMethod.GET)
  public ResponseEntity<List<Imovel>> criarCorretor(@PathVariable(value = "busca") String busca) {
